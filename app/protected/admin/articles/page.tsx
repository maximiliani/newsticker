...
import { Trash2, User, Eye, Calendar } from 'lucide-react';
...
export default function AdminArticlesPage() {
    ...
    useEffect(() => {
        async function checkAuthAndFetchData() {
            try {
                ...
                // Fetch articles grouped by user
                try {
    ...
    if (isLoading) {
        return (
            <DashboardShell>
                <PageHeading
                    heading="News Article Management"
                    text="Manage all news articles across the platform"
                />
                <div className="my-8">
